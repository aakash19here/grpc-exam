...
const file_exam_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"exam.proto\x12\x04exam\"N\n" +
	"\x14GetExamResultRequest\x12\x1d\n" +
	"\n" +
	"student_id\x18\x01 \x01(\tR\tstudentId\x12\x17\n" +
	"\aexam_id\x18\x02 \x01(\tR\x06examId\"\xb2\x01\n" +
	"\x15GetExamResultResponse\x12!\n" +
	"\fstudent_name\x18\x01 \x01(\tR\vstudentName\x12\x18\n" +
	"\asubject\x18\x02 \x01(\tR\asubject\x12%\n" +
	"\x0emarks_obtained\x18\x03 \x01(\x05R\rmarksObtained\x12\x1f\n" +
	"\vtotal_marks\x18\x04 \x01(\x05R\n" +
	"totalMarks\x12\x14\n" +
	"\x05grade\x18\x05 \x01(\tR\x05grade\"\x9a\x01\n" +
	"\x17SubmitExamResultRequest\x12\x1d\n" +
	"\n" +
	...
	"\vtotal_marks\x18\x04 \x01(\x05R\n" +
	"totalMarks\"\xed\x01\n" +
	"\x18SubmitExamResultResponse\x12\x1d\n" +
	"\n" +
	"student_id\x18\x01 \x01(\tR\tstudentId\x12\x1f\n" +
	"\vtotal_exams\x18\x02 \x01(\x05R\n" +
	"totalExams\x120\n" +
	"\x14total_marks_obtained\x18\x03 \x01(\x05R\x12totalMarksObtained\x120\n" +
	"\x14total_possible_marks\x18\x04 \x01(\x05R\x12totalPossibleMarks\x12-\n" +
	"\x12average_percentage\x18\x05 \x01(\x02R\x11averagePercentage\"T\n" +
...
var file_exam_proto_goTypes = []any{
	...
	(*GetExamResultResponse)(nil),    // 1: exam.GetExamResultResponse
	(*SubmitExamResultRequest)(nil),  // 2: exam.SubmitExamResultRequest
	(*SubmitExamResultResponse)(nil), // 3: exam.SubmitExamResultResponse
	(*StreamExamResultsRequest)(nil), // 4: exam.StreamExamResultsRequest
}
